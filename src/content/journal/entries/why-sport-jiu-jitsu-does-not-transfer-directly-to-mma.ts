...
export const whySportJiuJitsuDoesNotTransferDirectlyToMma: DraftArticle = {
  ...
  sections: [
    ...
    {
      id: "the-fence-is-a-surface",
      heading: "The fence is a surface, not a boundary",
      paragraphs: [
        "A competition mat has an edge that stops the action. When grapplers reach it, the referee resets them, usually in the centre, and the position is reconstructed. The enclosure in mixed martial arts does the opposite: it is a wall that can be used.",
        "Nevada specifies the object. A fenced area must be circular or have at least six equal sides, must be no smaller than 20 feet wide and no larger than 32 feet wide, must have its floor padded with at least a one-inch layer of closed-cell foam, and must be enclosed by fencing that prevents a combatant falling out. Fence posts run between five and seven feet above the floor. The construction is not a backdrop; it is a load-bearing part of the geometry.",
        "The Unified Rules then set out exactly how much of that surface is available. A fighter may put their hands on the fence and push off it at any time. A fighter may place their feet onto the cage and let their toes go through the fencing material at any time. What is illegal is the moment fingers or toes go through and grab, and begin to control either their own body position or the opponent's. If it happens, the referee may deduct a point where the foul had substantial effect, and if the fouling fighter finishes in a superior position because of it, the fighters are restarted standing in a neutral position.",
        "Read that clause as a grappler and it tells you two things at once. Pressing against the wall is a legitimate structure that a mat does not provide, so a body that has nowhere to retreat can be held in place with less effort than an open mat would require. And an athlete used to a competition surface where reaching the edge produces relief has to unlearn the expectation, because here the edge is where the work happens.",
      ],
    },
    {
      id: "the-clock-is-not-the-same-clock",
      heading: "The clock is not the same clock",
      paragraphs: [
        "Under the Unified Rules a round lasts five minutes, with a one-minute rest between rounds, and no contest exceeds five rounds or twenty-five minutes. Nevada adds that a non-championship contest must not exceed three rounds and a championship or special event five.",
    ...
    {
      id: "the-scorecard-does-not-pay-for-holding",
      heading: "The scorecard does not pay for holding",
      paragraphs: [
        "The last difference is the one that most directly contradicts what a points-based grappling ruleset teaches, and it is stated twice in the ABC document in almost the same words.",
        "The first statement governs the referee. Under the heading on standing up or breaking fighters, the rules direct that the referee shall stand up or break the fighters when neither is demonstrating real, significant or sustained effort to advance towards finishing the fight, and then add the sentence that does the work: simply maintaining what may be perceived as a superior position will not be considered effort to advance towards finishing the fight, nor grounds for a guaranteed opportunity to maintain that position.",
        "The second governs the judges. Scoring runs on a ten-point must system, with effective striking and grappling weighed first, and effective aggressiveness and control of the fighting area considered only if the first category is even. Effective grappling is assessed by successful executions and by the impact of takedowns, submission attempts, advantageous positions and reversals. Then, under dominance: merely holding a dominant position shall not be a primary factor in assessing dominance, and what the fighter does with those positions is what must be assessed.",
        "Set that beside a grappling table that pays a fixed number of points for arriving in a position and holding it for three seconds. Under one document, arriving and stabilising is the transaction. Under the other, arriving and stabilising is explicitly disclaimed as sufficient, and the referee is instructed to end it. An athlete whose sense of a good exchange was calibrated against the first document is carrying a valuation the second document rejects in writing.",
      ],
    },
    {
      id: "what-this-argument-is-and-is-not",
      heading: "What this argument is, and what it is not",
      paragraphs: [
        "Everything above is a reading of rules. It is not a measurement of transfer, and the distinction matters more than it usually gets.",
  ...
  sources: [
    ...
    {
      title:
        "Unified Rules of Mixed Martial Arts, July 2022 text: foul 10 (downward pointing elbow strike) and the previous grounded-fighter definition at foul 12",
      publisher: "Association of Boxing Commissions and Combative Sports",
      url: "https://www.abcboxing.com/wp-content/uploads/2022/08/unified-rules-mma-july-2022.pdf",
      accessed: "2026-08-03",
    },
    {
      title:
    ...
    {
      title:
        "Erik Magraken, \"MMA's Two Brand New Rules\": the July 2024 ABC vote on the 12-6 elbow and the grounded-fighter definition, with a 1 November 2024 implementation date",
      publisher: "Combat Sports Law",
      url: "https://combatsportslaw.com/2024/07/24/mmas-two-brand-new-rules/",
      accessed: "2026-08-03",
    },
    {
      title:
        "Brett Okamoto, \"ABC votes to remove 12-6 elbow ban, redefines grounded opponent\", 23 July 2024",
      publisher: "ESPN",
      url: "https://www.espn.com/mma/story/_/id/40627706/abc-votes-remove-12-6-elbow-ban-redefines-grounded-opponent",
      accessed: "2026-08-03",
    },
    {
      title:
        "Bianca Miarka, Fabricio B. Del Vecchio, Suzi Camey and John A. Amtmann, \"Comparisons: Technical-Tactical and Time-Motion Analysis of Mixed Martial Arts by Outcomes\", Journal of Strength and Conditioning Research 30(7), 1975-1984 (2016)",
      publisher: "PubMed, National Library of Medicine",
      url: "https://pubmed.ncbi.nlm.nih.gov/26670995/",
      accessed: "2026-08-03",
    },
    {
      title:
    ...
    {
      title: "ADCC Rules and Regulations: match durations and the unscored opening period",
