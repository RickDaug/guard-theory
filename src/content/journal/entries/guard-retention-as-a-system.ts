  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Change the document and the definition moves with it. In the submission-only events Spanias and colleagues analysed, no points exist for position at all, and the paper's most striking observation is that athletes winning by lower-body submissions exerted no positional control prior to their victory. Under that ruleset, giving up the guard in the ordinary sense costs nothing directly and is one route to the most frequent finish in the sample. Whether the legs stayed in front stops being the question.",
      ],
    },
    {
