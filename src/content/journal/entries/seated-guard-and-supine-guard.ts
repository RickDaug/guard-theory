...
export const seatedGuardAndSupineGuard: PublishedArticle = {
  ...
  metaDescription:
    "Sitting up and lying back are taught as preferences. Treat them as two control problems with different failure modes and the choice stops being taste.",
  sections: [
    {
  ...
  contestedNotes: [
    ...
    "The standing and ground percentages come from a study of no-gi submission-only competition with 26 regional and 26 international athletes. They describe that sample and that ruleset, and should not be generalised to points competition or to the gi.",
    "That paper disagrees with itself. Its abstract gives a standing-to-ground time ratio of 1:2, while its own Tables 4 and 5 give 9 per cent standing against 87 per cent ground, and stand-up times of 28 and 21 seconds against ground times of 208 and 279 seconds - ratios closer to 1:7 and 1:13. We have used the tables, because they are the data. The abstract figure appears to be an error in the source.",
