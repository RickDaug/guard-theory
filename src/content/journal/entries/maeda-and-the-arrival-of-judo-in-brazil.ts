 ...
 * says so in the body text rather than picking whichever version reads best.
...
export const maedaAndTheArrivalOfJudoInBrazil: PublishedArticle = {
  ...
  sections: [
    {
      ...
      heading: "What is actually agreed",
      paragraphs: [
        "The story most people are handed goes like this. A Japanese judo master is sent around the world by the founder of judo, fights a thousand times without losing, lands in Brazil, and teaches a frail teenager named Carlos Gracie, who passes it to his brother, who changes it into something new. It is a clean story with a beginning, a middle and an heir.",
        "Very little of that survives contact with the sources, and the parts that do survive are smaller and stranger than the summary. So it is worth starting with the short list of things the competing accounts do not fight about.",
        "Mitsuyo Maeda was born in 1878 in Funazawa village, in Aomori Prefecture in northern Japan. He trained at the Kodokan, the institution Kano Jigoro founded, and rose quickly inside it. He spent most of his adult life outside Japan, first in the United States and Europe and then across Latin America, making a living from public contests. He reached Brazil in 1914 and settled in Belem, at the mouth of the Amazon, in 1915. He taught there. He died in Belem in November 1941, at 63.",
        "Everything else, including the parts the sport's identity is built on, is argued about by people who have read the newspapers.",
      ],
    },
    {
    ...
    {
      id: "the-arrival-dates-do-not-agree",
      heading: "The arrival dates do not agree",
      paragraphs: [
    ...
    {
      id: "the-fight-record-that-is-not-a-record",
    ...
    {
      id: "who-taught-carlos-gracie",
      heading: "Who taught Carlos Gracie, and what he was given",
      paragraphs: [
    ...
    {
      id: "the-other-line-out-of-belem",
    ...
    {
      id: "what-maeda-was-doing-in-the-amazon",
      heading: "What Maeda was doing in the Amazon",
      paragraphs: [
        "One reason the teaching record is thin is that teaching was not what most of his Brazilian years were about.",
        "It is not an accident that the fullest institutional account of his life sits inside Japan's National Diet Library project on a century of Japanese emigration to Brazil rather than in a martial arts archive. The column has him teaching judo to police and military, taking private students, and taking part in settlement projects for Japanese emigrants in the Amazon. He died, in its phrasing, without ever seeing the development of the Amazon fulfilled.",
        "In Japanese-Brazilian history, in other words, Maeda is an emigration figure who also taught grappling. In grappling history he is a founder who happened to live in Brazil. Both fields have quietly reshaped him to fit, and neither framing is wrong so much as partial. Drysdale's blunter version is that Maeda was not very different from a competitor today, trying to make a living from something he was good at.",
      ],
    },
    {
      id: "reading-an-origin-story",
      heading: "Reading an origin story",
      paragraphs: [
  ...
  sources: [
    ...
    {
      title: "Roberto Pedreira, \"Top 20 Myths about Mitsuyo Maeda\" (question-and-answer)",
    ...
    {
      title:
        "Roberto Pedreira, Choque: The Untold Story of Jiu-Jitsu in Brazil, Volume 1, 1856-1949 (book record)",
      publisher: "Google Books",
      url: "https://books.google.com/books/about/Choque.html?id=gc80rgEACAAJ",
      accessed: "2026-08-03",
    },
    {
      title: "Luiz Franca, fighter record and lineage entry",
      publisher: "BJJ Heroes",
