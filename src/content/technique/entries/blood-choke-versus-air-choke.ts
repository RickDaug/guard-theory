...
export const bloodChokeVersusAirChoke: TechniqueEntry = {
  slug: "blood-choke-versus-air-choke",
  category: "submissions",
  title: "Blood choke versus air choke",
  summary:
  ...
  metaDescription:
    "A blood choke compresses the carotids at the sides of the neck; an air choke, the trachea. Knowing which your grip is applying explains why a strangle stalls.",
  ...
  trainingProgression: [
    "Static: with a cooperative partner, set a rear strangle and hold it with no pressure at all. Have them tell you where they feel contact, at the front or on both sides.",
    ...
    "Chin drill: partner defends only by tucking the chin. Practise the mechanical answers, moving the head, changing the angle or attacking the arm, without adding force.",
  ...
  relatedSlugs: ["seat-belt-and-hooks", "closed-guard-posture-battle"],
};
